...
Route::get('/allCategories', 'CategoryController@getAll')->name('allCategories');
...
Route::get('/allUnits', 'UnitController@getAll')->name('allUnits');
...
Route::get('/allSubcategories', 'SubcategoryController@getAll')->name('allSubcategories');
...
Route::get('/allProducts', 'ProductController@getAll')->name('allProducts');
...
Route::get('/allClients', 'ClientController@getAll')->name('allClients');
...
Route::get('/allVendors', 'VendorController@getAll')->name('allVendors');
...
Route::get('/getClientinfo', 'QuotationController@getClientinfo');
Route::get('/getSub', 'QuotationController@getSub');
Route::get('/getProduct', 'QuotationController@getProduct');
Route::get('/getProductinfo', 'QuotationController@getProductinfo');
//Route::get('/allVendors', 'VendorController@getAll')->name('allVendors');
