...
-- Dumping structure for table w3q.admins
...
-- Dumping data for table w3q.admins: ~1 rows (approximately)
...
-- Dumping structure for table w3q.blogs
...
-- Dumping data for table w3q.blogs: ~17 rows (approximately)
...
-- Dumping structure for table w3q.categories
...
-- Dumping data for table w3q.categories: ~5 rows (approximately)
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
INSERT INTO `categories` (`id`, `name`, `status`, `created_at`, `updated_at`, `order_by`) VALUES
	(2, 'CCTV camera', 0, '2021-05-09 11:21:01', '2021-05-09 12:20:19', 1),
	(3, 'Ip camera', 1, '2021-05-09 12:29:40', '2021-05-09 12:29:40', 1),
	(4, 'Akash Dth', 1, '2021-05-09 12:56:26', '2021-05-09 12:56:26', 1),
	(6, 'Laptop', 1, '2021-05-09 13:25:51', '2021-05-09 13:25:51', 1),
	(7, 'Router', 1, '2021-05-09 13:36:43', '2021-05-09 16:15:10', 2);
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;

-- Dumping structure for table w3q.clients
...
-- Dumping data for table w3q.clients: ~2 rows (approximately)
/*!40000 ALTER TABLE `clients` DISABLE KEYS */;
INSERT INTO `clients` (`id`, `name`, `address`, `mobile`, `order_by`, `status`, `email`, `contactperson`, `created_at`, `updated_at`) VALUES
	(5, 'CMP', 'Dampara', '01832566520', 2, 1, 'cmp@gmail.com', 'BAbul', '2021-05-09 17:18:16', '2021-05-09 17:18:16'),
	(6, 'CUET', 'Rawjan Abashik', '01533144177', 3, 0, 'cuet@gmail.com', 'Abdullah', '2021-05-09 17:20:07', '2021-05-09 17:28:21');
/*!40000 ALTER TABLE `clients` ENABLE KEYS */;

-- Dumping structure for table w3q.failed_jobs
...
-- Dumping data for table w3q.failed_jobs: ~0 rows (approximately)
/*!40000 ALTER TABLE `failed_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `failed_jobs` ENABLE KEYS */;

-- Dumping structure for table w3q.migrations
...
-- Dumping data for table w3q.migrations: ~15 rows (approximately)
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(17, '2021_05_08_163809_create_categories_table', 8),
	(18, '2021_05_09_150316_create_clients_table', 9),
	(19, '2021_05_10_114733_create_vendors_table', 10);
/*!40000 ALTER TABLE `migrations` ENABLE KEYS */;

-- Dumping structure for table w3q.model_has_permissions
...
-- Dumping data for table w3q.model_has_permissions: ~0 rows (approximately)
/*!40000 ALTER TABLE `model_has_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `model_has_permissions` ENABLE KEYS */;

-- Dumping structure for table w3q.model_has_roles
...
-- Dumping data for table w3q.model_has_roles: ~2 rows (approximately)
...
-- Dumping structure for table w3q.oauth_access_tokens
...
-- Dumping data for table w3q.oauth_access_tokens: ~15 rows (approximately)
...
INSERT INTO `oauth_access_tokens` (`id`, `user_id`, `client_id`, `name`, `scopes`, `revoked`, `created_at`, `updated_at`, `expires_at`) VALUES
	...
	('09d90efb6b09556ac7131e1475b452e6dadb92d180bae5afe0f1624651bb1f871520ecede5916cd1', 1, 6, 'adminApiToken', '[]', 0, '2021-04-12 12:59:52', '2021-04-12 12:59:52', '2022-04-12 12:59:52'),
	('0eb0afd40a2c0c84dfc18327dff3742e4abe91dad7d1d9dd97cc2d20bc888de4fccbb931f33a83a1', 1, 6, 'adminApiToken', '[]', 0, '2021-05-08 17:06:01', '2021-05-08 17:06:01', '2022-05-08 17:06:01'),
	...
	('38587f51d635a95c795ad31a98ce0bec281f2016732fc5c3df8afa3e220edf5d0e440262f1e6e8d4', 1, 6, 'adminApiToken', '[]', 0, '2021-05-10 11:40:01', '2021-05-10 11:40:01', '2022-05-10 11:40:01'),
	('38c1609e1679bb9bc0519c68eb16be4344ee42b64f8f351201f547f11f56a4911934b82f5ff36ab8', 1, 6, 'adminApiToken', '[]', 0, '2021-05-09 11:13:32', '2021-05-09 11:13:32', '2022-05-09 11:13:32'),
	('659ddae24cfe111cf6eee14f6b6f525cf12c04bf8ebc48802fa8ac91c6de0ad926503cd326f402b3', 1, 6, 'adminApiToken', '[]', 0, '2021-04-12 15:59:07', '2021-04-12 15:59:07', '2022-04-12 15:59:07'),
	...
	('d17b7ec61f8e00ee0790eba2292e557dbfe9db4f897dd6755fe88efc268858623bf34551160a6e68', 1, 6, 'adminApiToken', '[]', 0, '2021-05-08 11:29:56', '2021-05-08 11:29:56', '2022-05-08 11:29:56'),
...
-- Dumping structure for table w3q.oauth_auth_codes
...
-- Dumping data for table w3q.oauth_auth_codes: ~0 rows (approximately)
/*!40000 ALTER TABLE `oauth_auth_codes` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth_auth_codes` ENABLE KEYS */;

-- Dumping structure for table w3q.oauth_clients
...
-- Dumping data for table w3q.oauth_clients: ~7 rows (approximately)
...
INSERT INTO `oauth_clients` (`id`, `user_id`, `name`, `secret`, `provider`, `redirect`, `personal_access_client`, `password_client`, `revoked`, `created_at`, `updated_at`) VALUES
	...
	(6, NULL, 'Laravel Personal Access Client', 'V2YtoV4g4eFhQUapUAZu0gzNyO1dZIOKXIFyHAcV', NULL, 'http://localhost', 1, 0, 0, '2021-04-11 15:32:25', '2021-04-11 15:32:25'),
	(7, NULL, 'Laravel Password Grant Client', '7GaGxZeHoj35bpeM0iBB4mfHAZlm8dP79O2IW1Io', 'users', 'http://localhost', 0, 1, 0, '2021-04-11 15:32:25', '2021-04-11 15:32:25');
/*!40000 ALTER TABLE `oauth_clients` ENABLE KEYS */;

-- Dumping structure for table w3q.oauth_personal_access_clients
...
-- Dumping data for table w3q.oauth_personal_access_clients: ~3 rows (approximately)
/*!40000 ALTER TABLE `oauth_personal_access_clients` DISABLE KEYS */;
INSERT INTO `oauth_personal_access_clients` (`id`, `client_id`, `created_at`, `updated_at`) VALUES
	(1, 1, '2020-07-12 21:40:52', '2020-07-12 21:40:52'),
	(2, 4, '2020-09-26 17:58:06', '2020-09-26 17:58:06'),
	(3, 6, '2021-04-11 15:32:25', '2021-04-11 15:32:25');
/*!40000 ALTER TABLE `oauth_personal_access_clients` ENABLE KEYS */;

-- Dumping structure for table w3q.oauth_refresh_tokens
...
-- Dumping data for table w3q.oauth_refresh_tokens: ~0 rows (approximately)
/*!40000 ALTER TABLE `oauth_refresh_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth_refresh_tokens` ENABLE KEYS */;

-- Dumping structure for table w3q.password_resets
...
-- Dumping data for table w3q.password_resets: ~0 rows (approximately)
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;

-- Dumping structure for table w3q.permissions
...
-- Dumping data for table w3q.permissions: ~21 rows (approximately)
...
-- Dumping structure for table w3q.roles
...
-- Dumping data for table w3q.roles: ~2 rows (approximately)
...
-- Dumping structure for table w3q.role_has_permissions
...
-- Dumping data for table w3q.role_has_permissions: ~4 rows (approximately)
...
-- Dumping structure for table w3q.settings
...
-- Dumping data for table w3q.settings: ~1 rows (approximately)
...
-- Dumping structure for table w3q.users
...
-- Dumping data for table w3q.users: ~2 rows (approximately)
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `file_path`, `status`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(2, 'Dhiman', 'dhiman@gmail.com', NULL, '$2y$10$NEwZcXjU82ArhLVVqlfZ.O7eSzJ2/e4z9r2FgU5njCvrUpgsuAovC', 'assets/images/users/default.png', 0, NULL, '2021-05-08 12:41:23', '2021-05-08 12:41:44');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

-- Dumping structure for table w3q.vendors
...
-- Dumping data for table w3q.vendors: ~1 rows (approximately)
/*!40000 ALTER TABLE `vendors` DISABLE KEYS */;
INSERT INTO `vendors` (`id`, `name`, `address`, `mobile`, `email`, `contactperson`, `created_at`, `updated_at`, `order_by`, `status`) VALUES
	(2, 'Pran', 'Agrabad abashik', '01835212255', 'pran@gmail.com', 'Asad', '2021-05-10 13:41:31', '2021-05-10 13:52:10', 2, 1);
